...
sapdata<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/mRMR/Sap_SVM_Selected.csv")

seedarray <- c(1234,131,124,689,320,420,987,150,489,143,323,550,740,430,303,264,456,970,950,880)
...
write.csv(sapdata,"F:/Thesis/DataMing+MachieLeaning/CAD/mRMR/Sap_SVM_Selected.csv")
