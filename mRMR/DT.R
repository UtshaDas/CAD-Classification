...
library(rpart.plot)
library(pROC)
training<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/mRMR/CAD Dataset Train70p.csv")
testing<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/mRMR/CAD Dataset Test30p.csv")
sapdata<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/mRMR/Sap_DT_Selected.csv")
...
write.csv(sapdata,"F:/Thesis/DataMing+MachieLeaning/CAD/mRMR/Sap_DT_Selected.csv")
print(cp_op)
print(max_dep)
print(min_split)
print(accu)
