...
library(pROC)
trainDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/ATLEAST3/CAD Dataset Train70p.csv")
testDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/ATLEAST3/CAD Dataset Test30p.csv")
...
PredictionsWithClass<- predict(modelRandom, testDF[,1:19], type = 'class')
