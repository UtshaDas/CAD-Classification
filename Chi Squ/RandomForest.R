...
library(pROC)
trainDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/Chi Squ/CAD Dataset Train70p.csv")
testDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/Chi Squ/CAD Dataset Test30p.csv")
...
PredictionsWithClass<- predict(modelRandom, testDF[,1:21], type = 'class')
