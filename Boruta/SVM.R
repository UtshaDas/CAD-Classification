...
sapdata<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/Boruta/Sap_SVM_Selected.csv")
...
write.csv(sapdata,"F:/Thesis/DataMing+MachieLeaning/CAD/Boruta/Sap_SVM_Selected.csv")
