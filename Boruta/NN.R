library(neuralnet)
library(pROC)
trainDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/Boruta/CAD Dataset Train70p.csv")
testDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/Boruta/CAD Dataset Test30p.csv")
...
PredictionsWithClass <- compute(neuralModel,testDF[,1:13]) 
