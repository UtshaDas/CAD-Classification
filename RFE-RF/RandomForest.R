...
library(pROC)
trainDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/RFE-RF/CAD Dataset Train70p.csv")
testDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/RFE-RF/CAD Dataset Test30p.csv")
