...
library(pROC)
trainDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/For All/CAD Dataset Train70p.csv")
testDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/For All/CAD Dataset Test30p.csv")
...
PredictionsWithClass<- predict(modelRandom, testDF[,1:66], type = 'class')
