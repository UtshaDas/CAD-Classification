...
library(pROC)
trainDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/ATLEAST4/CAD Dataset Train70p.csv")
testDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/ATLEAST4/CAD Dataset Test30p.csv")
...
PredictionsWithClass<- predict(modelRandom, testDF[,1:14], type = 'class')
