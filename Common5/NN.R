library(neuralnet)
library(pROC)
trainDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/Common5/CAD Dataset Train70p.csv")
testDF<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/Common5/CAD Dataset Test30p.csv")
...
neuralModel<-neuralnet(formula=form, data=trainDF, hidden = c(3), threshold = 0.001,
