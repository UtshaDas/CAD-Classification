rm(list=ls())
training<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/Common5/CAD Dataset Train70p.csv")
testing<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/Common5/CAD Dataset Test30p.csv")
sapdata<-read.csv("F:/Thesis/DataMing+MachieLeaning/CAD/Common5/Sap_SVM_Selected.csv")
...
write.csv(sapdata,"F:/Thesis/DataMing+MachieLeaning/CAD/Common5/Sap_SVM_Selected.csv")
